...
def test_normalize_number_japanese_units():
    assert normalize_number("8,800万") == 88_000_000
    assert normalize_number("1.6億") == 160_000_000
    assert normalize_number("12000000") == 12_000_000
...
"""
    ...
    assert record.price == 88_000_000
    assert record.annual_rent == 7_800_000
